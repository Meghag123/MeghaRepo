...
System.out.println("the company nam="+company);
      ...
      <% }else{
 		...
 		background-colour:green;
 				...
 				<h1 style="font-family:verdana;" > Company Description</h1><br>
 				<h3><% out.println(it.getCompdes());%><br><br></b></h3>
 				
 				
 				
 				
 			<h1 style="font-family:verdana;"> Company Vacancy</h1><br>
 		<h3><% 	out.println(it.getCompvac());%><br><br></h3>
 			
 			<h1 style="font-family:verdana;"> Company Role</h1><br>
